...
public class OrderInfoMapper {
    ...
    public OrderInfoDTO toDTO(OrderInfo orderInfo){
        return new OrderInfoDTO(
                ...
                orderInfo.getDeliveryPerson().getMemberName(),
                orderInfo.getDeliveryPerson().getMemberSurname(),
                orderInfo.getSeller().getMemberId(),
                orderInfo.getSeller().getMemberName(),
                orderInfo.getSeller().getMemberSurname(),
